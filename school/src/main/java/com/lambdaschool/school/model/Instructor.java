...
@ApiModel(value = "Instructor", description =  "All the instructors courses can have")
@Entity
...
public class Instructor
{
    ...
    @ApiModelProperty(name = "instructname", value = "Instructor Name", required = true, example = "Frank")
